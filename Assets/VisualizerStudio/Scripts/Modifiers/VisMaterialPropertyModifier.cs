...
{	
    ...
    public override void SetProperty(float propertyValue)
    {
        ...
        if (setAsProceduralMaterial &&
            ...
            rendererComp != null &&
            materialIndex >= 0 &&
            materialIndex < rendererComp.sharedMaterials.Length &&
#if (!UNITY_3_5 && !UNITY_3_4 && !UNITY_3_3 && !UNITY_3_2 && !UNITY_3_1 && !UNITY_3_0_0 && !UNITY_3_0 && !UNITY_2_6_1 && !UNITY_2_6) && (UNITY_STANDALONE_OSX || UNITY_STANDALONE_WIN || UNITY_WEBPLAYER || UNITY_EDITOR)
            rendererComp.sharedMaterials[materialIndex] as ProceduralMaterial)
        {//get indexed material as procedural material
            targetMaterial = rendererComp.sharedMaterials[materialIndex];
        }
#else
            true)
        {//can't sure procedural materials on IOS or Android!            
            Debug.LogWarning("Procedural Materials cannot be used on IOS or Android, and also requires Unity 3.4 or later!");
                 ...
                 rendererComp != null &&
                 rendererComp.sharedMaterial != null &&
#if (!UNITY_3_5 && !UNITY_3_4 && !UNITY_3_3 && !UNITY_3_2 && !UNITY_3_1 && !UNITY_3_0_0 && !UNITY_3_0 && !UNITY_2_6_1 && !UNITY_2_6) && (UNITY_STANDALONE_OSX || UNITY_STANDALONE_WIN || UNITY_WEBPLAYER || UNITY_EDITOR)
                 rendererComp.sharedMaterial as ProceduralMaterial)
        {//get main material as procedural material
            targetMaterial = rendererComp.sharedMaterial;
        }
#else
                 true)
        {//can't sure procedural materials on IOS or Android!            
